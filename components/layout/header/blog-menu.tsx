...
import FeaturedPostMenuItem from "@/components/media/featured-post-menu-item";
import Poster from "@/components/media/carousel/poster";
import { Film, InstagramPost, Post } from "@/types";
import InstagramPostComponent from "@/components/media/carousel/instagram-post";
...
const BlogMenu = ({
  ...
  return (
    <NavigationMenu viewport={isMobile} className="max-w-full h-auto md:h-17.5">
      <NavigationMenuList className="flex-wrap space-x-2 items-center">
        <NavigationMenuItem className="p-2 md:p-5">
          ...
          <NavigationMenuContent className="p-5">
            <ul className="grid gap-x-3 gap-y-2 w-full md:w-100 lg:w-125 grid-cols-[1fr_1fr] items-center">
        ...
        <NavigationMenuItem className="p-2 md:p-5">
          ...
          <NavigationMenuContent className="p-5">
            <ul className="grid gap-x-3 gap-y-2 w-full md:w-100 lg:w-125 grid-cols-[1fr_.75fr]">
